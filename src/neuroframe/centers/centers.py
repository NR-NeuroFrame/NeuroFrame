...
# 1. Section: Functions
# ================================================================
def get_segments_centers(mouse: Mouse, info_df: pd.DataFrame, mode: str) -> pd.DataFrame:
    # 1. Extract the data
    ...
    # 3. Builds the DF
    left_df, right_df, average_df = build_center_df(mouse, centers, volumes, info_df)
